...
public class TopProductsByRevenueWidget implements DashboardWidget {
    ...
    public void loadData(String csvPath) throws Exception {
        ...
        for (int i = 1; i < rows.size(); i++) {
            ...
            dataset.addValue(revenue, "Revenue", product);
        }
        chart = ChartFactory.createBarChart(
                "Top 10 Products By Revenue", "Product", "Revenue", dataset);
